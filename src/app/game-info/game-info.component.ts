...
export class GameInfoComponent implements OnInit, OnChanges {
  ...
  // void bedeutet das die methote was ausführt und nichts zurück gibt.
  ngOnChanges(): void {
    //Dieser parameter sorgt dafür das diese aufgerufen wird, wenn sich unser Input parameter ändert
    if (this.card) {
      let cardNumber = +this.card.split('_')[1]; // mit dem + wird der String zu einer Number
